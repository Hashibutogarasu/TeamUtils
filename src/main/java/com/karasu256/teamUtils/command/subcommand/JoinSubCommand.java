...
public class JoinSubCommand extends AbstractJoinOrLeaveSubCommand {
    public JoinSubCommand(ICommand parent) {
        super("join", parent);
    }
    ...
    public boolean onJoinOrLeave(Player player, String teamName) {
        return TeamUtility.addPlayerToTeam(player, teamName);
    }
